...
//	},
	...
	deleteCard: async function(idx) {
		...
		case 3:
			if (idx === childIdx[0]) {
				elmChilds[1].setAttribute('id', childIdx[1]-1);
				elmChilds[1].getElementsByTagName('a')[0].setAttribute('name', childIdx[1]-1);
				elmChilds[1].getElementsByTagName('a')[1].setAttribute('name', childIdx[1]-1);

				elmChilds[2].setAttribute('id', childIdx[2]-1);
				elmChilds[2].getElementsByTagName('a')[0].setAttribute('name', childIdx[2]-1);
				elmChilds[2].getElementsByTagName('a')[1].setAttribute('name', childIdx[2]-1);
			} else if (idx === childIdx[1]) {
				elmChilds[2].setAttribute('id', childIdx[2]-1);
				elmChilds[2].getElementsByTagName('a')[0].setAttribute('name', childIdx[2]-1);
				elmChilds[2].getElementsByTagName('a')[1].setAttribute('name', childIdx[2]-1);
			}
			...
			elmChildToRemove.remove();
			deck.deleteCard(idx);
			console.log(childIdx[2]+1);
			...
			currentPage = Math.ceil((parseInt(elmMain.lastChild.getAttribute('id'))+1)/view.cardsPerPage);
			!currentPage ? view.currentPage = 1 : view.currentPage = currentPage;
